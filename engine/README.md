...
BSD-3-Clause (its license ships with the sources under `third_party/`);
autocxx's own code remains MIT/Apache-2.0, so the crate's license expression
is `(MIT OR Apache-2.0) AND BSD-3-Clause`.
